...
const Navbar = () => {
  ...
  return (
    <motion.div
      ...
      className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-borderColor dark:border-gray-700 relative transition-all z-[100] ${location.pathname === "/" ? "bg-light dark:bg-slate-900" : "bg-white dark:bg-slate-900"
    ...
    >
      ...
      <div
        ...
        sm:flex-row items-start sm:items-center gap-4 sm:gap-8 max-sm:p-4 transition-all duration-300 z-50 ${location.pathname === "/" ? "bg-light dark:bg-slate-900" : "bg-white dark:bg-slate-900"
